...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Adds $r_2, \widetilde{e},\widetilde{r_2},\widetilde{r_3},\widetilde{s'}$ to set $\mathcal{U}$
        \item Computes
            \begin{itemize}
        ...
        \item Computes
            ...
            \end{itemize}
        \item Adds $r_3, s'$ to set $\mathcal{U}$
        \item Generates random non-zero values $\{\widetilde{m_i} \mod p\}_{i \in (I_h - I_l)}$.
        \item Computes
        \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Adds $\{\widehat{m_l}\}$ to set $\mathcal{Y}$
    \end{itemize}
