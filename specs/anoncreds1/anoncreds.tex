...
\subsubsection{Proof: $n$ is a product of two safe primes}
\begin{enumerate}
...
\subsubsection{Issuer Proof of Setup Correctness}
...
\printbibliography
 ...
 \ifdef{\fullpaper}{
 \section{Changelog}
 \subsection{7 Oct 2022 (version 0.7)}
	fixing missing references/citations. LaTeX Biber required 
	(added a bib-file and a reference section) 	
 \subsection{25 April 2022 (version 0.6)}
 \begin{itemize}
     \item Proof that n is a product of two safe primes in Section 4.3.1
     \item Issuer correctness proof no longer considered optional
 \end{itemize}
